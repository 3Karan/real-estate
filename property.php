	...
	<div class="container">
			...
			?>
				<div class="col-md-6">
					<div class="row mt-5">
						...
						<div class="col-md-6">
							<h6 style="white-space: nowrap; width: 100%; font-size: 18px; margin-top: 15px; color: #111; overflow: hidden; text-overflow: ellipsis;"><?php echo $row['title'] ?></h6>
		...
		<script>
			document.addEventListener("DOMContentLoaded", function () {
			    var propertyCount = <?php echo mysqli_num_rows($run); ?>;
			    if (propertyCount === 0) {
